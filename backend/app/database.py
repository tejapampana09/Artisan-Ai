    ...
    if eng.url.drivername.startswith("sqlite"):
        ...
        with eng.connect() as conn:
            pg_patches = [
                ...
                "ALTER TABLE users ADD COLUMN IF NOT EXISTS craft_specialization VARCHAR;",
                ...
                "ALTER TABLE products ADD COLUMN IF NOT EXISTS craft_process TEXT;",
                "ALTER TABLE products ADD COLUMN IF NOT EXISTS region_of_origin VARCHAR;",
                "ALTER TABLE products ADD COLUMN IF NOT EXISTS handmade_pct INTEGER DEFAULT 100;",
                "ALTER TABLE products ADD COLUMN IF NOT EXISTS production_time_days INTEGER DEFAULT 3;",
                "ALTER TABLE products ADD COLUMN IF NOT EXISTS secondary_images TEXT;",
                "ALTER TABLE products ADD COLUMN IF NOT EXISTS verification_status VARCHAR DEFAULT 'UNVERIFIED';",
                "ALTER TABLE products ADD COLUMN IF NOT EXISTS other_cost NUMERIC(12, 2) DEFAULT 0.00;",
                "ALTER TABLE products ADD COLUMN IF NOT EXISTS auto_smart_pricing_enabled BOOLEAN DEFAULT FALSE;",
                "ALTER TABLE products ADD COLUMN IF NOT EXISTS title_en VARCHAR;",
                "ALTER TABLE products ADD COLUMN IF NOT EXISTS description_en TEXT;",
                "ALTER TABLE products ADD COLUMN IF NOT EXISTS craft_story_en TEXT;",
                "ALTER TABLE products ADD COLUMN IF NOT EXISTS translations TEXT;",
                "ALTER TABLE orders ADD COLUMN IF NOT EXISTS cancellation_status VARCHAR DEFAULT 'NONE';",
                "ALTER TABLE orders ADD COLUMN IF NOT EXISTS cancellation_reason TEXT;",
                "ALTER TABLE orders ADD COLUMN IF NOT EXISTS tracking_history TEXT;",
                "ALTER TABLE interview_sessions ADD COLUMN IF NOT EXISTS market_research_result TEXT;",
            ]
            for stmt in pg_patches:
                try:
