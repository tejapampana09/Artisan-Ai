...
async def process_voice_and_image(
    ...
    Persists server-owned DraftCatalog and returns verified draft_token.
    """
...
def approve_and_publish_product(
    ...
    # 2. Strict Validation of human edits against Server-Owned Canonical ArtisanFacts 🔒 (Behavior B)
    raw_edited = {
        "title": req.title,
