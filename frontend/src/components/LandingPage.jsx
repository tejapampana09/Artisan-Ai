...
export default function LandingPage({ onSelectMode, onOpenAuth, user }) {
  ...
  return (
    <div className="space-y-12 pb-12 animate-fade-in">
      ...
      <section className="bg-[#FBF8F3] rounded-3xl p-6 sm:p-8 shadow-xs border border-[#EADFCF] max-w-2xl mx-auto space-y-6">
        <div className="text-center space-y-1">
          <span className="font-script text-[#933D1E] text-base block">Crafting a Better Tomorrow</span>
          ...
          <p className="text-xs text-[#6B5B51]">
            Choose your journey to empower traditional craft
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
          ...
          <div
            ...
            className="group p-5 rounded-2xl bg-white border-2 border-[#EADFCF] hover:border-[#933D1E] transition-all cursor-pointer flex flex-col justify-between space-y-4 hover:shadow-md"
          >
            <div className="space-y-1">
              <div className="w-10 h-10 rounded-xl bg-[#933D1E] text-white flex items-center justify-center shadow-xs">
                <Store className="w-5 h-5" />
              </div>
              <h3 className="font-serif font-bold text-base text-[#2A1E17] group-hover:text-[#933D1E] pt-2">
                I am an Artisan
              </h3>
              <p className="text-xs text-[#6B5B51]">
                Sell your craft with AI voice & camera tools
              </p>
            </div>
            <div className="flex items-center justify-between text-xs font-bold text-[#933D1E]">
          ...
          <div
            ...
            className="group p-5 rounded-2xl bg-white border-2 border-[#EADFCF] hover:border-[#2A1E17] transition-all cursor-pointer flex flex-col justify-between space-y-4 hover:shadow-md"
          >
            <div className="space-y-1">
              <div className="w-10 h-10 rounded-xl bg-[#2A1E17] text-white flex items-center justify-center shadow-xs">
                <ShoppingBag className="w-5 h-5" />
              </div>
              <h3 className="font-serif font-bold text-base text-[#2A1E17] pt-2">
                I am a Buyer
              </h3>
              <p className="text-xs text-[#6B5B51]">
                Discover unique authentic handmade products
              </p>
            </div>
            <div className="flex items-center justify-between text-xs font-bold text-[#2A1E17]">
      ...
      {/* Hero Banner Section */}
      <section className="relative overflow-hidden rounded-3xl bg-[#2A1E17] text-white p-8 md:p-14 shadow-2xl border border-[#933D1E]/40">
        {/* Background decorative ambient glow */}
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-[#933D1E]/20 rounded-full blur-3xl pointer-events-none"></div>
        <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-[#933D1E]/15 rounded-full blur-3xl pointer-events-none"></div>

        <div className="relative z-10 max-w-3xl space-y-6">
          <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-white/20 text-amber-200 text-xs font-semibold backdrop-blur-md">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4">
            {user?.role !== 'BUYER' && (
              <button
                ...
                className="flex items-center justify-center space-x-3 px-7 py-3.5 rounded-2xl bg-[#933D1E] hover:bg-[#7E3216] text-white font-bold text-base shadow-lg transition-all hover:scale-[1.02] cursor-pointer"
              >
                <Store className="w-5 h-5" />
            ...
            <button
              ...
              onClick={() => onSelectMode('BUY')}
              className="flex items-center justify-center space-x-3 px-7 py-3.5 rounded-2xl bg-white/10 hover:bg-white/20 border border-white/20 text-white font-bold text-base backdrop-blur-sm transition-all hover:scale-[1.02] cursor-pointer"
            >
          ...
          <div className="pt-6 grid grid-cols-2 sm:grid-cols-4 gap-4 border-t border-white/20 text-xs text-stone-300">
      ...
      <section className="space-y-6">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          ...
          <p className="text-sm text-[#6B5B51]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feat, idx) => (
            <div 
              key={idx}
              className="bg-[#FBF8F3] rounded-2xl p-6 border border-[#EADFCF] shadow-xs hover:border-[#933D1E] hover:shadow-md hover:border-[#933D1E]/50 shadow-sm hover:shadow-md transition-all space-y-3 group"
            >
              <div className="w-12 h-12 rounded-xl bg-[#FAF7F2] flex items-center justify-center border border-[#EADFCF] group-hover:bg-amber-50 group-hover:border-[#933D1E]/30 transition-colors">
                {feat.icon}
              </div>
      ...
      <section className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div>
            <div className="flex items-center space-x-2 text-xs font-bold text-[#933D1E] font-bold uppercase tracking-wider mb-1">
          ...
          <button
            onClick={() => onSelectMode('BUY')}
            className="inline-flex items-center space-x-2 text-sm font-bold text-[#933D1E] font-bold hover:text-[#933D1E] font-bold transition-colors cursor-pointer group"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {craftCategories.map((craft, idx) => (
            <div 
              key={idx}
              className="bg-[#FBF8F3] rounded-2xl overflow-hidden border border-[#EADFCF] shadow-xs hover:border-[#933D1E] hover:shadow-md shadow-sm hover:shadow-md transition-all flex flex-col group"
            >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between space-y-3">
                <div>
                  <h3 className="font-bold font-serif text-[#2A1E17] text-sm group-hover:text-[#933D1E] font-bold transition-colors">
                    {language === 'en' ? craft.name : getCraftSubName(craft)}
                  </h3>
                  {language !== 'en' && (
                    <div className="text-xs text-[#933D1E] font-bold font-medium">{craft.name}</div>
                  )}
                  <div className="text-[11px] text-[#6B5B51] mt-1">📍 {craft.origin}</div>
                  <p className="text-xs text-[#6B5B51] mt-2 line-clamp-2">
                    {craft.description}
                  </p>
                </div>
                ...
                <button
                  onClick={() => onSelectMode('BUY')}
                  className="w-full py-2 px-3 rounded-lg bg-[#FAF7F2] hover:bg-amber-50 text-[#2A1E17] hover:text-[#933D1E] font-bold text-xs font-semibold border border-[#EADFCF] hover:border-amber-300 transition-colors cursor-pointer text-center"
                >
      ...
      <section className="bg-[#FBF8F3] rounded-3xl p-8 md:p-12 border border-[#EADFCF] shadow-md shadow-xs">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center space-y-2">
            <h2 className="text-2xl sm:text-3xl font-extrabold font-serif text-[#2A1E17]">{t('howItWorksTitle', 'How It Works')}</h2>
            <p className="text-xs sm:text-sm text-[#6B5B51]">{t('howItWorksSub', 'Simplicity for the rural artisan. Confidence and transparency for the conscious buyer.')}</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* For Artisans */}
            <div className="bg-white rounded-2xl p-6 border border-[#933D1E]/30 space-y-4 shadow-2xs">
              <div className="flex items-center space-x-3 pb-3 border-b border-[#EADFCF]">
                <div className="w-10 h-10 rounded-xl bg-[#933D1E] text-white flex items-center justify-center font-bold">
                  <Store className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="font-bold font-serif text-[#2A1E17] text-base">{t('forMasterArtisans', 'For Master Artisans')}</h3>
                  <p className="text-xs text-[#6B5B51]">{t('fromWorkshopToGlobal', 'From workshop to global reach in minutes')}</p>
                </div>
              </div>

              <div className="space-y-3 text-xs text-[#2A1E17]">
                <div className="flex items-start space-x-3">
                  <span className="w-5 h-5 rounded-full bg-amber-100 text-[#933D1E] font-bold font-bold flex items-center justify-center shrink-0">1</span>
                ...
                <div className="flex items-start space-x-3">
                  <span className="w-5 h-5 rounded-full bg-amber-100 text-[#933D1E] font-bold font-bold flex items-center justify-center shrink-0">2</span>
                ...
                <div className="flex items-start space-x-3">
                  <span className="w-5 h-5 rounded-full bg-amber-100 text-[#933D1E] font-bold font-bold flex items-center justify-center shrink-0">3</span>
              ...
              <button
                ...
                className="w-full mt-2 py-2.5 rounded-xl bg-[#933D1E] hover:bg-[#7E3216] text-white font-bold text-xs transition-colors cursor-pointer text-center"
              >
            ...
            <div className="bg-white rounded-2xl p-6 border border-[#933D1E]/30 space-y-4 shadow-2xs">
              <div className="flex items-center space-x-3 pb-3 border-b border-[#EADFCF]">
                ...
                <div>
                  <h3 className="font-bold font-serif text-[#2A1E17] text-base">{t('forConsciousBuyers', 'For Conscious Buyers')}</h3>
                  <p className="text-xs text-[#6B5B51]">{t('directProvenance', 'Direct provenance, zero middleman markups')}</p>
                </div>
              </div>

              <div className="space-y-3 text-xs text-[#2A1E17]">
                <div className="flex items-start space-x-3">
                  <span className="w-5 h-5 rounded-full bg-indigo-100 text-[#933D1E] font-bold flex items-center justify-center shrink-0">1</span>
                ...
                <div className="flex items-start space-x-3">
                  <span className="w-5 h-5 rounded-full bg-indigo-100 text-[#933D1E] font-bold flex items-center justify-center shrink-0">2</span>
                  <span>{t('buyerStep2Text', 'Fair Price Transparency: See the cost breakdown of raw materials, labor, and artisan earnings.')}</span>
                </div>
                <div className="flex items-start space-x-3">
                  <span className="w-5 h-5 rounded-full bg-indigo-100 text-[#933D1E] font-bold flex items-center justify-center shrink-0">3</span>
        ...
        <div className="flex justify-center gap-3 pt-2">
          {user?.role !== 'BUYER' && (
            <button
              ...
              className="px-6 py-2.5 rounded-xl bg-[#933D1E] hover:bg-[#7E3216] text-white font-bold text-xs transition-colors cursor-pointer shadow-sm"
            >
          ...
          <button
            ...
            className={`px-6 py-2.5 rounded-xl font-bold text-xs transition-colors cursor-pointer ${
              user?.role === 'BUYER'
                ? 'bg-[#933D1E] hover:bg-[#7E3216] text-white shadow-sm'
