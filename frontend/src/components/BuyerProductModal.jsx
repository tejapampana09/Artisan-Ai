  ...
  return (
    <>
      <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
        <div className="bg-white rounded-3xl max-w-3xl w-full p-6 shadow-2xl border border-slate-200">
          <div className="flex justify-between items-start pb-4 border-b border-slate-100">
            <div>
              ...
              <h3 className="text-xl font-bold text-slate-900 mt-1">{product.title}</h3>
            </div>
          ...
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              ...
              <div className="mt-3 p-3 bg-slate-50 rounded-2xl border border-slate-200 flex justify-between items-center text-xs">
                <div>
                  <span className="text-slate-500 block text-[11px]">Fair Market Price:</span>
              ...
              <div className="mt-3 p-3.5 bg-gradient-to-br from-amber-50 to-orange-50/50 rounded-2xl border border-amber-200 space-y-2">
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 rounded-xl bg-amber-200 border border-amber-300 flex items-center justify-center font-bold text-amber-900 shrink-0">
                    🎨
                  </div>
